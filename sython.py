...
async def join_channel():
    try:
        await sython(JoinChannelRequest("@d8_8q"))
...
async def _(event):
        ...
        await sython.send_message('@zmmbot', 'جاري التجميع بواسطة | Source KiMo')
        channel_entity = await sython.get_entity(bot_username)
...
async def _(event):
      await event.reply("""السـورس يعمـل | KiMo
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
...
قناة السورس : https://t.me/d8_8q
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍"""
)

@sython.on(events.NewMessage(outgoing=True, pattern=".مطور"))
async def _(event):
      await event.reply("""SY OWNER : @T_5_C"""
)
